...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	Запрос.Текст = 
		...
		|	ВКМ_ОбслуживаниеКлиентов.ВКМ_ДатаПроведенияРабот КАК ВКМ_ДатаПроведенияРабот,
		|	ВКМ_ОбслуживаниеКлиентов.ВКМ_ВремяНачалаРабот КАК ВКМ_ВремяНачалаРабот
		|ИЗ
	...
	Если Выборка.Следующий() Тогда 
		...
		КонецЕсли;
	    Если ВКМ_ВремяНачалаРабот <> Выборка.ВКМ_ВремяНачалаРабот Тогда
